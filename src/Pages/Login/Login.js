...
const Login = () => {
  const { loading, setLoading, signInWithGoogle, signin, resetPassword, user } = useContext(AuthContext)
        ...
        >
          <div className='space-y-4'>
            <div>
              ...
              <input
                onBlur={(event) => setUserEmial(event.target.value)}
                type='email'
                name='email'
                id='email'
                required
